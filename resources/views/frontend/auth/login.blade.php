...
@section('content')
<x-forms.post :action="route('frontend.auth.login')" class="card card-md">
    <div class="card-body">
      <h2 class="card-title text-center mb-4">Login to your account</h2>
      <div class="mb-3">
        <label class="form-label">Username</label>
        <input type="username" name="username" id="username" class="form-control" placeholder="{{ __('Username') }}" value="{{ old('username') }}" maxlength="30" required autofocus autocomplete="username" />
      </div>
      <div class="mb-2">
