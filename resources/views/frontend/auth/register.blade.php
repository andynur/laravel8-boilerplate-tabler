        ...
        <x-slot name="body">
            <x-forms.post :action="route('frontend.auth.register')">
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="username" id="username" class="form-control" value="{{ old('Username') }}" placeholder="{{ __('username') }}" maxlength="100" required autofocus autocomplete="username" />
                    </div>
                </div><!--form-group-->
